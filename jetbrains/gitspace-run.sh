...
configure_ssh_server() {
    ...
    elif [ -n "${JETBRAINS_PASSWORD:-}" ]; then
        log_info "Setting SSH password from JETBRAINS_PASSWORD environment variable"
        echo "vscode:${JETBRAINS_PASSWORD}" | run_as_root chpasswd
    else
